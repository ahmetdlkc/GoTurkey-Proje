...
class tarihiyerlerIzmirpage extends StatefulWidget {
  const tarihiyerlerIzmirpage({Key? key}) : super(key: key);

  @override
  State<tarihiyerlerIzmirpage> createState() => _tarihiyerlerIzmirpageState();
}

class _tarihiyerlerIzmirpageState extends State<tarihiyerlerIzmirpage> {
  @override
