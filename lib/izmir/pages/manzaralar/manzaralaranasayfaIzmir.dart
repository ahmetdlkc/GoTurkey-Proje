...
import 'package:goturkey/izmir/pages/manzaralar/manzaralardetaysayfas.dart';
import 'package:goturkey/materials/appbar.dart';

class manzaralaranaIzmirpage extends StatefulWidget {
  const manzaralaranaIzmirpage({Key? key}) : super(key: key);

  @override
  State<manzaralaranaIzmirpage> createState() => _manzaralaranaIzmirpageState();
}

class _manzaralaranaIzmirpageState extends State<manzaralaranaIzmirpage> {
  @override
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    String ulasim =
                                        manzaralarList[index]["ulasim"];

                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              manzaralardetayIzmirpage(
                                                  adi,
                                                  adres,
                                                  fotograf,
                                                  hakkinda,
