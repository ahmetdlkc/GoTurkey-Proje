...
class manzaralardetayIzmirpage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim;

  const manzaralardetayIzmirpage(this.adi, this.adres, this.fotograf,
      this.hakkinda, this.semt, this.ulasim);

  @override
  State<manzaralardetayIzmirpage> createState() =>
      _manzaralardetayIzmirpageState();
}

class _manzaralardetayIzmirpageState extends State<manzaralardetayIzmirpage> {
