...
class hotel3yildizpage extends StatefulWidget {
  const hotel3yildizpage({Key? key}) : super(key: key);

  @override
  State<hotel3yildizpage> createState() => _hotel3yildizpageState();
}

class _hotel3yildizpageState extends State<hotel3yildizpage> {
  @override
