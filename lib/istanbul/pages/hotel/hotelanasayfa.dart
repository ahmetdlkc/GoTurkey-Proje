...
class hotelanasayfapage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
  ...
  @override
  State<hotelanasayfapage> createState() => _hotelanasayfapageState();
}

IconData kaydedildiIcon = Icons.bookmark_add_outlined;

class _hotelanasayfapageState extends State<hotelanasayfapage> {
  @override
