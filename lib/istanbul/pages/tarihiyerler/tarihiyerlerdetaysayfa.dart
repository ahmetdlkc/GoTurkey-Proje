...
class tarihiyerlerdetaypage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim;

  const tarihiyerlerdetaypage(this.adi, this.adres, this.fotograf,
      this.hakkinda, this.semt, this.ulasim);

  @override
  State<tarihiyerlerdetaypage> createState() => _tarihiyerlerdetaypageState();
}

class _tarihiyerlerdetaypageState extends State<tarihiyerlerdetaypage> {
