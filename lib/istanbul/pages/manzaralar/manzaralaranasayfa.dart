...
class manzaralaranapage extends StatefulWidget {
  const manzaralaranapage({Key? key}) : super(key: key);

  @override
  State<manzaralaranapage> createState() => _manzaralaranapageState();
}

class _manzaralaranapageState extends State<manzaralaranapage> {
  @override
