...
class manzaralardetaypage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim;

  const manzaralardetaypage(this.adi, this.adres, this.fotograf, this.hakkinda,
      this.semt, this.ulasim);

  @override
  State<manzaralardetaypage> createState() => _manzaralardetaypageState();
}

class _manzaralardetaypageState extends State<manzaralardetaypage> {
