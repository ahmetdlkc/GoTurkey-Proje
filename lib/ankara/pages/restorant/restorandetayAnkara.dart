...
class restorandetayAnkarapage extends StatefulWidget {
  final String adi, beslenmetur, fotograf, adres, mutfak, fiyat, semt;
  final int tel;

  const restorandetayAnkarapage(this.adi, this.adres, this.fotograf,
      this.mutfak, this.fiyat, this.beslenmetur, this.tel, this.semt);

  @override
  State<restorandetayAnkarapage> createState() =>
      _restorandetayAnkarapageState();
}

class _restorandetayAnkarapageState extends State<restorandetayAnkarapage> {
