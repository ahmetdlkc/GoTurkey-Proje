...
import 'package:goturkey/ankara/pages/restorant/restorandetayAnkara.dart';
import 'package:goturkey/materials/appbar.dart';

class restorananaAnkarapage extends StatefulWidget {
  const restorananaAnkarapage({Key? key}) : super(key: key);

  @override
  State<restorananaAnkarapage> createState() => _restorananaAnkarapageState();
}

class _restorananaAnkarapageState extends State<restorananaAnkarapage> {
  @override
