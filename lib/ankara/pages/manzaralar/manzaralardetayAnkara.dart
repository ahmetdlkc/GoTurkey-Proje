...
class manzaralardetayAnkarapage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt;

  const manzaralardetayAnkarapage(
      this.adi, this.adres, this.fotograf, this.hakkinda, this.semt);

  @override
  State<manzaralardetayAnkarapage> createState() =>
      _manzaralardetayAnkarapageState();
}

IconData kaydedildiIcon = Icons.bookmark_add_outlined;

class _manzaralardetayAnkarapageState extends State<manzaralardetayAnkarapage> {
  @override
