...
class hotel4yildizAnkarapage extends StatefulWidget {
  const hotel4yildizAnkarapage({Key? key}) : super(key: key);

  @override
  State<hotel4yildizAnkarapage> createState() => _hotel4yildizAnkarapageState();
}

class _hotel4yildizAnkarapageState extends State<hotel4yildizAnkarapage> {
  @override
