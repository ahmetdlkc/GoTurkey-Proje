...
class adminmanzaraIstguncellepage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim, docid;

  const adminmanzaraIstguncellepage(this.adi, this.adres, this.fotograf,
      this.hakkinda, this.semt, this.ulasim, this.docid);

  @override
  State<adminmanzaraIstguncellepage> createState() =>
      _adminmanzaraIstguncellepageState();
}

class _adminmanzaraIstguncellepageState
    extends State<adminmanzaraIstguncellepage> {
  @override
