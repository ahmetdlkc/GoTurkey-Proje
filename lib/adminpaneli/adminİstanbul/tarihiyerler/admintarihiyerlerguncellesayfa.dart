...
class admintarihiyerlerIstguncellepage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim, docid;

  const admintarihiyerlerIstguncellepage(this.adi, this.adres, this.fotograf,
      this.hakkinda, this.semt, this.ulasim, this.docid);

  @override
  State<admintarihiyerlerIstguncellepage> createState() =>
      _admintarihiyerlerIstguncellepageState();
}

class _admintarihiyerlerIstguncellepageState
    extends State<admintarihiyerlerIstguncellepage> {
  @override
