...
class adminhotelguncellepage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
  ...
  @override
  State<adminhotelguncellepage> createState() => _adminhotelguncellepageState();
}

class _adminhotelguncellepageState extends State<adminhotelguncellepage> {
  @override
  Widget build(BuildContext context) {
    ...
    final _olanak4Controller = TextEditingController()
      ..text = "${widget.olanak4}";
    final _olanak5Controller = TextEditingController()
      ..text = "${widget.olanak5}";
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        await _database
                          ...
                          "Olanak5": "${_olanak5Controller.text}",
                        });
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>
                                    admin5yildizlihotelpage()));
                      },
