...
class admin5yildizlihotelpage extends StatefulWidget {
  const admin5yildizlihotelpage({Key? key}) : super(key: key);

  @override
  State<admin5yildizlihotelpage> createState() =>
      _admin5yildizlihotelpageState();
}
...
class _admin5yildizlihotelpageState extends State<admin5yildizlihotelpage> {
