...
class admin3yildizlihotelpage extends StatefulWidget {
  const admin3yildizlihotelpage({Key? key}) : super(key: key);

  @override
  State<admin3yildizlihotelpage> createState() =>
      _admin3yildizlihotelpageState();
}
...
class _admin3yildizlihotelpageState extends State<admin3yildizlihotelpage> {
                        ...
                        child: PopupMenuButton<MenuItem>(
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              String olanak5 = hotel5yildiz[index]["Olanak5"];

                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        adminhotelguncellepage(
                                            adi,
                                            adres,
                                            fiyat,
                                            fotograf,
