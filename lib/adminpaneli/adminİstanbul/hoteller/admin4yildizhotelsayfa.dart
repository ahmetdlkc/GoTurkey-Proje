...
class admin4yildizhotelpage extends StatefulWidget {
  const admin4yildizhotelpage({Key? key}) : super(key: key);

  @override
  State<admin4yildizhotelpage> createState() => _admin4yildizhotelpageState();
}
...
class _admin4yildizhotelpageState extends State<admin4yildizhotelpage> {
