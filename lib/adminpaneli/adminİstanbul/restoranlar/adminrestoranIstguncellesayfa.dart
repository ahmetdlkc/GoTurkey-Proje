...
class adminrestoranIstguncelpage extends StatefulWidget {
  final String adi, beslenmetur, fotograf, adres, mutfak, fiyat, semt, docid;
  final int tel;

  const adminrestoranIstguncelpage(
      this.adi,
      this.adres,
      this.fotograf,
      this.mutfak,
  ...
  @override
  State<adminrestoranIstguncelpage> createState() =>
      _adminrestoranIstguncelpageState();
}

class _adminrestoranIstguncelpageState
    extends State<adminrestoranIstguncelpage> {
  @override
