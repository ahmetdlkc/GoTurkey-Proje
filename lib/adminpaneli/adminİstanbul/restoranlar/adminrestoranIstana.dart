...
class adminrestoranIstpage extends StatefulWidget {
  const adminrestoranIstpage({Key? key}) : super(key: key);

  @override
  State<adminrestoranIstpage> createState() => _adminrestoranIstpageState();
}
...
class _adminrestoranIstpageState extends State<adminrestoranIstpage> {
