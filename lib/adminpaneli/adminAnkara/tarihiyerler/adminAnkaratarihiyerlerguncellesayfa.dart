...
class admintarihiyerlerAnkaraguncellepage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim, docid;

  const admintarihiyerlerAnkaraguncellepage(this.adi, this.adres, this.fotograf,
      this.hakkinda, this.semt, this.ulasim, this.docid);

  @override
  State<admintarihiyerlerAnkaraguncellepage> createState() =>
      _admintarihiyerlerAnkaraguncellepageState();
}

class _admintarihiyerlerAnkaraguncellepageState
    extends State<admintarihiyerlerAnkaraguncellepage> {
  @override
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    admintarihiyerlerAnkaraanapage()));
                      },
