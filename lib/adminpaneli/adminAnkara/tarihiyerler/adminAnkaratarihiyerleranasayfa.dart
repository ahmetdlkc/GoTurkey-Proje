...
class admintarihiyerlerAnkaraanapage extends StatefulWidget {
  const admintarihiyerlerAnkaraanapage({Key? key}) : super(key: key);

  @override
  State<admintarihiyerlerAnkaraanapage> createState() =>
      _admintarihiyerlerAnkaraanapageState();
}
...
class _admintarihiyerlerAnkaraanapageState
    extends State<admintarihiyerlerAnkaraanapage> {
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        admintarihiyerlerAnkaraguncellepage(
                                            adi,
                                            adres,
                                            fotograf,
                                            hakkinda,
