...
class adminmanzaralarAnkaraanapage extends StatefulWidget {
  const adminmanzaralarAnkaraanapage({Key? key}) : super(key: key);

  @override
  State<adminmanzaralarAnkaraanapage> createState() =>
      _adminmanzaralarAnkaraanapageState();
}
...
class _adminmanzaralarAnkaraanapageState
    extends State<adminmanzaralarAnkaraanapage> {
                            ...
                            onSelected: (value) async {
                              if (value == MenuItem.guncelle) {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          adminmanzaraAnkaraguncellepage(
                                              adi,
                                              adres,
                                              fotograf,
                                              hakkinda,
