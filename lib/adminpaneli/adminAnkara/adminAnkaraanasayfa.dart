...
class adminAnkaraanapage extends StatefulWidget {
  const adminAnkaraanapage({Key? key}) : super(key: key);

  @override
  State<adminAnkaraanapage> createState() => _adminAnkaraanapageState();
}

class _adminAnkaraanapageState extends State<adminAnkaraanapage> {
  @override
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => admintarihiyerlerAnkaraanapage(),
                    ),
                  );
                },
                child: Container(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => adminrestoranAnkarapage(),
                    ),
                  );
                },
                child: Container(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => adminmanzaralarAnkaraanapage(),
                    ),
                  );
                },
                child: Container(
