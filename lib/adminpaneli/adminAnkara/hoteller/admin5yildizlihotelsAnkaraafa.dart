...
class admin5yildizlihotelAnkarapage extends StatefulWidget {
  const admin5yildizlihotelAnkarapage({Key? key}) : super(key: key);

  @override
  State<admin5yildizlihotelAnkarapage> createState() =>
      _admin5yildizlihotelAnkarapageState();
}
...
class _admin5yildizlihotelAnkarapageState
    extends State<admin5yildizlihotelAnkarapage> {
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        adminhotel5yildizguncelleAnkarapage(
                                            adi,
                                            adres,
                                            fiyat,
                                            fotograf,
