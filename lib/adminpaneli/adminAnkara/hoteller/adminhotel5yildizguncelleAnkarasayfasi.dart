...
class adminhotel5yildizguncelleAnkarapage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
      ...
      docid;
  final int tel, fiyat;
  const adminhotel5yildizguncelleAnkarapage(
      this.adi,
      this.adres,
      this.fiyat,
      this.fotograf,
  ...
  @override
  State<adminhotel5yildizguncelleAnkarapage> createState() =>
      _adminhotel5yildizguncelleAnkarapageState();
}

class _adminhotel5yildizguncelleAnkarapageState
    extends State<adminhotel5yildizguncelleAnkarapage> {
  @override
