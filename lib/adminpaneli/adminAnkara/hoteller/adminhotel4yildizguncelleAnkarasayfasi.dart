...
class adminhotel4yildizguncelleAnkarapage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
      ...
      docid;
  final int tel, fiyat;
  const adminhotel4yildizguncelleAnkarapage(
      this.adi,
      this.adres,
      this.fiyat,
      this.fotograf,
  ...
  @override
  State<adminhotel4yildizguncelleAnkarapage> createState() =>
      _adminhotel4yildizguncelleAnkarapageState();
}

class _adminhotel4yildizguncelleAnkarapageState
    extends State<adminhotel4yildizguncelleAnkarapage> {
  @override
