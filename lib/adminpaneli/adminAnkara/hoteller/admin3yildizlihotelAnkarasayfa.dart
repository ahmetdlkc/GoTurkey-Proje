...
class admin3yildizlihotelAnkarapage extends StatefulWidget {
  const admin3yildizlihotelAnkarapage({Key? key}) : super(key: key);

  @override
  State<admin3yildizlihotelAnkarapage> createState() =>
      _admin3yildizlihotelAnkarapageState();
}
...
class _admin3yildizlihotelAnkarapageState
    extends State<admin3yildizlihotelAnkarapage> {
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        adminhotel3yildizguncelleAnkarapage(
                                            adi,
                                            adres,
                                            fiyat,
                                            fotograf,
