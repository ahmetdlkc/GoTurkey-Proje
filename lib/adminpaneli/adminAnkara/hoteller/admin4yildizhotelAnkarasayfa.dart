...
class admin4yildizhotelAnkarapage extends StatefulWidget {
  const admin4yildizhotelAnkarapage({Key? key}) : super(key: key);

  @override
  State<admin4yildizhotelAnkarapage> createState() =>
      _admin4yildizhotelAnkarapageState();
}
...
class _admin4yildizhotelAnkarapageState
    extends State<admin4yildizhotelAnkarapage> {
          ...
          leading: InkWell(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => adminhotelAnkarayildizpage()));
            },
            child: Padding(
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        adminhotel4yildizguncelleAnkarapage(
                                            adi,
                                            adres,
                                            fiyat,
                                            fotograf,
