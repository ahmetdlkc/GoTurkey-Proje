...
class adminmanzaraIzmirguncellepage extends StatefulWidget {
  final String adi, hakkinda, fotograf, adres, semt, ulasim, docid;

  const adminmanzaraIzmirguncellepage(this.adi, this.adres, this.fotograf,
      this.hakkinda, this.semt, this.ulasim, this.docid);

  @override
  State<adminmanzaraIzmirguncellepage> createState() =>
      _adminmanzaraIzmirguncellepageState();
}

class _adminmanzaraIzmirguncellepageState
    extends State<adminmanzaraIzmirguncellepage> {
  @override
