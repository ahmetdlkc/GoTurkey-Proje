...
import 'package:goturkey/adminpaneli/adminIzmir/restoranlar/adminrestoranIzmirguncellesayfa.dart';

class adminrestoranIzmirpage extends StatefulWidget {
  const adminrestoranIzmirpage({Key? key}) : super(key: key);

  @override
  State<adminrestoranIzmirpage> createState() => _adminrestoranIzmirpageState();
}
...
class _adminrestoranIzmirpageState extends State<adminrestoranIzmirpage> {
