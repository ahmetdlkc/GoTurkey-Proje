...
class adminrestoranIzmirguncelpage extends StatefulWidget {
  final String adi, beslenmetur, fotograf, adres, mutfak, fiyat, semt, docid;
  final int tel;

  const adminrestoranIzmirguncelpage(
      this.adi,
      this.adres,
      this.fotograf,
      this.mutfak,
  ...
  @override
  State<adminrestoranIzmirguncelpage> createState() =>
      _adminrestoranIzmirguncelpageState();
}

class _adminrestoranIzmirguncelpageState
    extends State<adminrestoranIzmirguncelpage> {
  @override
