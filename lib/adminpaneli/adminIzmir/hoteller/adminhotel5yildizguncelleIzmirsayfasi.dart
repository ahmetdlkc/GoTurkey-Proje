...
class adminhotel5yildizguncelleIzmirpage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
      ...
      docid;
  final int tel, fiyat;
  const adminhotel5yildizguncelleIzmirpage(
      this.adi,
      this.adres,
      this.fiyat,
      this.fotograf,
  ...
  @override
  State<adminhotel5yildizguncelleIzmirpage> createState() =>
      _adminhotel5yildizguncelleIzmirpageState();
}

class _adminhotel5yildizguncelleIzmirpageState
    extends State<adminhotel5yildizguncelleIzmirpage> {
  @override
