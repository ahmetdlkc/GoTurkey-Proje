...
class adminhotel4yildizguncelleIzmirpage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
      ...
      docid;
  final int tel, fiyat;
  const adminhotel4yildizguncelleIzmirpage(
      this.adi,
      this.adres,
      this.fiyat,
      this.fotograf,
  ...
  @override
  State<adminhotel4yildizguncelleIzmirpage> createState() =>
      _adminhotel4yildizguncelleIzmirpageState();
}

class _adminhotel4yildizguncelleIzmirpageState
    extends State<adminhotel4yildizguncelleIzmirpage> {
  @override
