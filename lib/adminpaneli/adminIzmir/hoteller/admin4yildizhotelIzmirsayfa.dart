...
import 'package:goturkey/adminpaneli/adminAnkara/hoteller/adminhotel4yildizguncelleAnkarasayfasi.dart';
import 'package:goturkey/adminpaneli/adminAnkara/hoteller/adminhotelyildizAnkarasayfasi.dart';
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/adminhotel4yildizguncelleIzmirsayfasi.dart';
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/adminhotelyildizIzmirsayfasi.dart';

class admin4yildizhotelIzmirpage extends StatefulWidget {
  const admin4yildizhotelIzmirpage({Key? key}) : super(key: key);

  @override
  State<admin4yildizhotelIzmirpage> createState() =>
      _admin4yildizhotelIzmirpageState();
}
...
class _admin4yildizhotelIzmirpageState
    extends State<admin4yildizhotelIzmirpage> {
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        adminhotel4yildizguncelleIzmirpage(
                                            adi,
                                            adres,
                                            fiyat,
                                            fotograf,
