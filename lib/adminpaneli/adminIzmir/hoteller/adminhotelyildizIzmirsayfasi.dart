...
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/admin3yildizlihotelIzmirsayfa.dart';
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/admin4yildizhotelIzmirsayfa.dart';
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/admin5yildizlihotelsIzmirafa.dart';
import 'package:goturkey/adminpaneli/adminanasayfa.dart';

class adminhotelIzmiryildizpage extends StatefulWidget {
  const adminhotelIzmiryildizpage({Key? key}) : super(key: key);

  @override
  State<adminhotelIzmiryildizpage> createState() =>
      _adminhotelIzmiryildizpageState();
}

class _adminhotelIzmiryildizpageState extends State<adminhotelIzmiryildizpage> {
  @override
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => admin5yildizlihotelIzmirpage(),
                    ),
                  );
                },
                child: Container(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => admin4yildizhotelIzmirpage(),
                    ),
                  );
                },
                child: Container(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => admin3yildizlihotelIzmirpage(),
                    ),
                  );
                },
                child: Container(
