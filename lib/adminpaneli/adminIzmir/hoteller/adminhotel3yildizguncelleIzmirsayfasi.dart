...
class adminhotel3yildizguncelleIzmirpage extends StatefulWidget {
  final String adi,
      hakkinda,
      fotograf,
      adres,
      ...
      docid;
  final int tel, fiyat;
  const adminhotel3yildizguncelleIzmirpage(
      this.adi,
      this.adres,
      this.fiyat,
      this.fotograf,
  ...
  @override
  State<adminhotel3yildizguncelleIzmirpage> createState() =>
      _adminhotel3yildizguncelleIzmirpageState();
}

class _adminhotel3yildizguncelleIzmirpageState
    extends State<adminhotel3yildizguncelleIzmirpage> {
  @override
