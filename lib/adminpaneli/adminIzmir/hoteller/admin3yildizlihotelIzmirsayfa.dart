...
import 'package:goturkey/adminpaneli/adminAnkara/hoteller/adminhotel3yildizguncelleAnkarasayfasi.dart';
import 'package:goturkey/adminpaneli/adminAnkara/hoteller/adminhotelyildizAnkarasayfasi.dart';
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/adminhotel3yildizguncelleIzmirsayfasi.dart';
import 'package:goturkey/adminpaneli/adminIzmir/hoteller/adminhotelyildizIzmirsayfasi.dart';

class admin3yildizlihotelIzmirpage extends StatefulWidget {
  const admin3yildizlihotelIzmirpage({Key? key}) : super(key: key);

  @override
  State<admin3yildizlihotelIzmirpage> createState() =>
      _admin3yildizlihotelIzmirpageState();
}
...
class _admin3yildizlihotelIzmirpageState
    extends State<admin3yildizlihotelIzmirpage> {
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        adminhotel3yildizguncelleIzmirpage(
                                            adi,
                                            adres,
                                            fiyat,
                                            fotograf,
