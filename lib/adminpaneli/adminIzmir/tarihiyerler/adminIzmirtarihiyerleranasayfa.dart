...
import 'package:goturkey/adminpaneli/adminAnkara/tarihiyerler/adminAnkaratarihiyerlerguncellesayfa.dart';
import 'package:goturkey/adminpaneli/adminIzmir/adminIzmiranasayfa.dart';
import 'package:goturkey/adminpaneli/adminIzmir/tarihiyerler/adminIzmirtarihiyerlerguncellesayfa.dart';
import 'package:goturkey/adminpaneli/adminanasayfa.dart';

class admintarihiyerlerIzmiranapage extends StatefulWidget {
  const admintarihiyerlerIzmiranapage({Key? key}) : super(key: key);

  @override
  State<admintarihiyerlerIzmiranapage> createState() =>
      _admintarihiyerlerIzmiranapageState();
}
...
class _admintarihiyerlerIzmiranapageState
    extends State<admintarihiyerlerIzmiranapage> {
          ...
          leading: InkWell(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => adminIzmiranapage()));
            },
            child: Padding(
                          ...
                          onSelected: (value) async {
                            if (value == MenuItem.guncelle) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        admintarihiyerlerIzmirguncellepage(
                                            adi,
                                            adres,
                                            fotograf,
                                            hakkinda,
